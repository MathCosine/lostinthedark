const SETS = [
  ...
  },
  {
    ...
    problems: [
      ...
      'An equilateral triangle and a regular hexagon have equal perimeters. If the area of the equilateral triangle is 4, what is the area of the regular hexagon?',
      ...
      'The sum $\\dfrac{1}{1 \\cdot 2} + \\dfrac{1}{2 \\cdot 3} + \\dfrac{1}{3 \\cdot 4} + \\cdots + \\dfrac{1}{19 \\cdot 20}$ equals $\\dfrac{m}{n}$ in lowest terms. Find $m + n$.',
    ],
    answers: ['8', '6', '7', '39'],
  },
  {
  ...
  },
  {
    ...
    problems: [
      ...
      'How many integers from 1 to 1000 can be written as a sum of two or more consecutive positive integers?',
    ],
    answers: ['9', '12', '543', '990'],
  },
  {
    number: 8,
    points: 18,
    ...
    problems: [
      ...
      'Square $ABCD$ has side length 4. Point $E$ lies on $\\overline{AB}$ with $AE = 1$, and point $F$ lies on $\\overline{BC}$ with $BF = 2$. Find the area of triangle $DEF$.',
